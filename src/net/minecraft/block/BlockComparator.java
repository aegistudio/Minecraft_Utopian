...
public class BlockComparator extends BlockRedstoneLogic implements ITileEntityProvider
{
    ...
    protected int getInputStrength(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (var10 > 0)
        {
            ...
            if (whocallme.getBlock(var10).hasComparatorInputOverride())
            {
                var6 = whocallme.getBlock(var10).getComparatorInputOverride(par1World, var8, par3, var9, Direction.rotateOpposite[var7]);
            }
            else if (var6 < 15 && Block.isNormalCube(var10))
            {
                ...
                if (var10 > 0 && whocallme.getBlock(var10).hasComparatorInputOverride())
                {
                    var6 = whocallme.getBlock(var10).getComparatorInputOverride(par1World, var8, par3, var9, Direction.rotateOpposite[var7]);
                }
            }
