...
public class BlockPumpkin extends BlockDirectional
{
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return (var5 == 0 || BlockInfoContainer.getBlockInfoContainer().getBlock(var5).blockMaterial.isReplaceable()) && par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4);
    }
