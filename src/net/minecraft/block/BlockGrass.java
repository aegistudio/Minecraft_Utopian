...
public class BlockGrass extends Block
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            if (par1World.getBlockLightValue(par2, par3 + 1, par4) < 4 && whocallme.getLookupOpacity(par1World.getBlockId(par2, par3 + 1, par4)) > 2)
            {
            ...
            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    if (par1World.getBlockId(var7, var8, var9) == Block.dirt.blockID && par1World.getBlockLightValue(var7, var8 + 1, var9) >= 4 && whocallme.getLookupOpacity(var10) <= 2)
                    {
