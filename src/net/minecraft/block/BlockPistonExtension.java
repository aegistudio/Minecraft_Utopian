...
public class BlockPistonExtension extends Block
{
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (var8 == Block.pistonBase.blockID || var8 == Block.pistonStickyBase.blockID)
        {
            ...
            {
                BlockInfoContainer.getBlockInfoContainer().getBlock(var8).dropBlockAsItem(par1World, par2, par3, par4, par6, 0);
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        {
            BlockInfoContainer.getBlockInfoContainer().getBlock(var7).onNeighborBlockChange(par1World, par2 - Facing.offsetsXForSide[var6], par3 - Facing.offsetsYForSide[var6], par4 - Facing.offsetsZForSide[var6], par5);
        }
    }
