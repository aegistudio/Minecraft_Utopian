...
public class BlockRail extends BlockRailBase
{
    ...
    {
        if (par7 > 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(par7).canProvidePower() && (new BlockBaseRailLogic(this, par1World, par2, par3, par4)).getNumberOfAdjacentTracks() == 3)
        {
