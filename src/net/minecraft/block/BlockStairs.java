...
public class BlockStairs extends Block implements IBlockStair
{
    ...
    {
        return par0 > 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(par0) instanceof BlockStairs;
    }
