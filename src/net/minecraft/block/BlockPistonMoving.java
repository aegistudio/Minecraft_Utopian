...
public class BlockPistonMoving extends BlockContainer
{
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            if (var8 != null)
            {
                BlockInfoContainer.getBlockInfoContainer().getBlock(var8.getStoredBlockID()).dropBlockAsItem(par1World, par2, par3, par4, var8.getBlockMetadata(), 0);
            }
        }
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        if (var5 != null)
        {
            Block var6 = BlockInfoContainer.getBlockInfoContainer().getBlock(var5.getStoredBlockID());
    ...
    public AxisAlignedBB getAxisAlignedBB(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        ...
        {
            AxisAlignedBB var8 = BlockInfoContainer.getBlockInfoContainer().getBlock(par5).getCollisionBoundingBoxFromPool(par1World, par2, par3, par4);
