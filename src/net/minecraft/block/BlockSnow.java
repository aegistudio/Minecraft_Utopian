...
public class BlockSnow extends Block
{
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return var5 == 0 ? false : (var5 == this.blockID && (par1World.getBlockMetadata(par2, par3 - 1, par4) & 7) == 7 ? true : (var5 != Block.leaves.blockID && !BlockInfoContainer.getBlockInfoContainer().getBlock(var5).isOpaqueCube() ? false : par1World.getBlockMaterial(par2, par3 - 1, par4).blocksMovement()));
    }
