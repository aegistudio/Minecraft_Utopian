...
public class BlockVine extends Block
{
    ...
    private boolean canBePlacedOn(int par1)
    {
        ...
        {
            Block var2 = BlockInfoContainer.getBlockInfoContainer().getBlock(par1);
        ...
        if (!par1World.isRemote && par1World.rand.nextInt(4) == 0)
        {
            ...
            else
            {
                ...
                if (var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0)
                {
                    ...
                    if (var12 != 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(var12) != null)
                    {
                        if (BlockInfoContainer.getBlockInfoContainer().getBlock(var12).blockMaterial.isOpaque() && BlockInfoContainer.getBlockInfoContainer().getBlock(var12).renderAsNormalBlock())
                        {
