        ...
        if (!par1World.isRemote)
        {
            ...
            if (var5 != this.blockID && var6 != this.blockID)
            {
                if (var7 != this.blockID && var8 != this.blockID)
                {
                    ...
                    if (whocallme.getLookupOpaqueCube(var5) && !whocallme.getLookupOpaqueCube(var6))
                    {
                        var13 = 3;
                    }

                    if (whocallme.getLookupOpaqueCube(var6) && !whocallme.getLookupOpaqueCube(var5))
                    {
                        var13 = 2;
                    }

                    if (whocallme.getLookupOpaqueCube(var7) && !whocallme.getLookupOpaqueCube(var8))
                    {
                        var13 = 5;
                    }

                    if (whocallme.getLookupOpaqueCube(var8) && !whocallme.getLookupOpaqueCube(var7))
                    {
                        var13 = 4;
                    }
                }
                else
                {
                    ...
                    if ((whocallme.getLookupOpaqueCube(var5) || whocallme.getLookupOpaqueCube(var10)) && !whocallme.getLookupOpaqueCube(var6) && !whocallme.getLookupOpaqueCube(var11))
                    {
                        var13 = 3;
                    }

                    if ((whocallme.getLookupOpaqueCube(var6) || whocallme.getLookupOpaqueCube(var11)) && !whocallme.getLookupOpaqueCube(var5) && !whocallme.getLookupOpaqueCube(var10))
                    {
                        var13 = 2;
                    }
                }
            ...
            else
            {
                ...
                if ((whocallme.getLookupOpaqueCube(var7) || whocallme.getLookupOpaqueCube(var10)) && !whocallme.getLookupOpaqueCube(var8) && !whocallme.getLookupOpaqueCube(var11))
                {
                    var13 = 5;
                }

                if ((whocallme.getLookupOpaqueCube(var8) || whocallme.getLookupOpaqueCube(var11)) && !whocallme.getLookupOpaqueCube(var7) && !whocallme.getLookupOpaqueCube(var10))
                {
                    var13 = 4;
                }
            }
