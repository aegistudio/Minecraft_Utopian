...
public class BlockTripWire extends Block
{
    ...
    private void updateTripWireState(World par1World, int par2, int par3, int par4)
    {
        ...
        boolean var7 = false;
        List<Entity> var8 = par1World.getEntitiesWithinAABBExcludingEntity((Entity)null, AxisAlignedBB.getAABBPool().getAABB((double)par2 + this.minX, (double)par3 + this.minY, (double)par4 + this.minZ, (double)par2 + this.maxX, (double)par3 + this.maxY, (double)par4 + this.maxZ));

        if (!var8.isEmpty())
        {
            Iterator<Entity> var9 = var8.iterator();
