...
public class WorldServer extends World
{
            ...
            if (this.rand.nextInt(16) == 0)
            {
                ...
                if (this.isRaining())
                {
                    ...
                    if (var12.canSpawnLightningBolt())
                    {
                        ...
                        if (var13 != 0)
                        {
                            whocallme.getBlock(var13).fillWithRain(this, var9 + var5, var11 - 1, var10 + var6);
                        }
                    }
                }
            }
            ...
            for (var10 = 0; var10 < var9; ++var10)
            {
                ...
                if (var21 != null && var21.getNeedsRandomTick())
                {
                    for (int var20 = 0; var20 < 3; ++var20)
                    {
                        ...
                        ++var2;
                        Block var18 = whocallme.getBlock(var17);
            ...
            while (var14.hasNext())
            {
                ...
                if (this.checkChunksExist(var4.xCoord - var5, var4.yCoord - var5, var4.zCoord - var5, var4.xCoord + var5, var4.yCoord + var5, var4.zCoord + var5))
                {
                    ...
                    if (var6 > 0 && Block.isAssociatedBlockID(var6, var4.blockID))
                    {
                        try
                        {
                            whocallme.getBlock(var6).updateTick(this, var4.xCoord, var4.yCoord, var4.zCoord, this.rand);
                        }
    ...
    private boolean onBlockEventReceived(BlockEventData par1BlockEventData)
    {
        ...
        return var2 == par1BlockEventData.getBlockID() ? whocallme.getBlock(var2).onBlockEventReceived(this, par1BlockEventData.getX(), par1BlockEventData.getY(), par1BlockEventData.getZ(), par1BlockEventData.getEventID(), par1BlockEventData.getEventParameter()) : false;
    }
