...
public class Chunk
{
            ...
            while (var3 < 16)
            {
                ...
                while (true)
                {
                    if (var4 > 0)
                    {
                        ...
                        if (whocallme.getLookupOpacity(var5) == 0)
                        {
                            --var4;
                            continue;
                        }
    ...
    {
    	BlockInfoContainer whocallme = BlockInfoContainer.getBlockInfoContainer();
        return whocallme.getLookupOpacity(this.getBlockID(par1, par2, par3));
    }
    ...
    public boolean setBlockIDWithMetadata(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            {
                whocallme.getBlock(var8).onSetBlockIDWithMetaData(this.worldObj, var12, par2, var13, var9);
            }
            ...
            if (var8 != 0)
            {
                ...
                {
                    whocallme.getBlock(var8).breakBlock(this.worldObj, var12, par2, var13, var8, var9);
                }
                else if (whocallme.getBlock(var8) instanceof ITileEntityProvider && var8 != par4)
                {
            ...
            else
            {
                ...
                {
                	//XXX whats this
                    if (whocallme.getLookupOpacity(par4 & 4095) > 0)
                    {
                        if (par2 >= var7)
                        {
                ...
                if (par4 != 0)
                {
                    if (!this.worldObj.isRemote)
                    {
                        whocallme.getBlock(par4).onBlockAdded(this.worldObj, var12, par2, var13);
                    }

                    if (whocallme.getBlock(par4) instanceof ITileEntityProvider)
                    {
                        var14 = this.getChunkBlockTileEntity(par1, par2, par3);

                        if (var14 == null)
                        {
                            var14 = ((ITileEntityProvider)whocallme.getBlock(par4)).createNewTileEntity(this.worldObj);
                ...
                else if (var8 > 0 && whocallme.getBlock(var8) instanceof ITileEntityProvider)
                {
                    var14 = this.getChunkBlockTileEntity(par1, par2, par3);
    ...
    public boolean setBlockMetadata(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (var7 > 0 && whocallme.getBlock(var7) instanceof ITileEntityProvider)
                {
    ...
    public TileEntity getChunkBlockTileEntity(int par1, int par2, int par3)
    {
        ...
        if (var5 == null)
        {
            ...
            if (var6 <= 0 || !whocallme.getBlock(var6).hasTileEntity())
            {
                return null;
            }
            ...
            if (var5 == null)
            {
                var5 = ((ITileEntityProvider)whocallme.getBlock(var6)).createNewTileEntity(this.worldObj);
    ...
    public int getPrecipitationHeight(int par1, int par2)
    {
        ...
        if (var4 == -999)
        {
            ...
            while (var5 > 0 && var4 == -1)
            {
                ...
                Material var7 = var6 == 0 ? Material.air : whocallme.getBlock(var6).blockMaterial;
    ...
    public void enqueueRelightChecks()
    {
        ...
        for (int var1 = 0; var1 < 8; ++var1)
        {
            ...
            for (int var7 = 0; var7 < 16; ++var7)
            {
                ...
                {
                    if (whocallme.getLookupLightValue(this.worldObj.getBlockId(var5, var8 - 1, var6)) > 0)
                    {
                    ...
                    if (whocallme.getLookupLightValue(this.worldObj.getBlockId(var5 - 1, var8, var6)) > 0)
                    {
                    ...
                    if (whocallme.getLookupLightValue(this.worldObj.getBlockId(var5, var8, var6 - 1)) > 0)
                    {
