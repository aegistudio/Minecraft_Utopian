...
public class ExtendedBlockStorage
{
    ...
    public void setExtBlockID(int par1, int par2, int par3, int par4)
    {
        ...
        if (var5 == 0 && par4 != 0)
        {
            ...
            if (whocallme.getBlock(par4) != null && whocallme.getBlock(par4).getTickRandomly())
            {
                ++this.tickRefCount;
            }
        }
        else if (var5 != 0 && par4 == 0)
        {
            ...
            if (whocallme.getBlock(var5) != null && whocallme.getBlock(var5).getTickRandomly())
            {
                --this.tickRefCount;
            }
        }
        else if (whocallme.getBlock(var5) != null && whocallme.getBlock(var5).getTickRandomly() && (whocallme.getBlock(par4) == null || !whocallme.getBlock(par4).getTickRandomly()))
        {
            --this.tickRefCount;
        }
        else if ((whocallme.getBlock(var5) == null || !whocallme.getBlock(var5).getTickRandomly()) && whocallme.getBlock(par4) != null && whocallme.getBlock(par4).getTickRandomly())
        ...
        for (int var1 = 0; var1 < 16; ++var1)
        {
            for (int var2 = 0; var2 < 16; ++var2)
            {
                for (int var3 = 0; var3 < 16; ++var3)
                {
                    ...
                    if (var4 > 0)
                    {
                        if (whocallme.getBlock(var4) == null)
                        {
                        ...
                        else
                        {
                            ...
                            if (whocallme.getBlock(var4).getTickRandomly())
                            {
                                ++this.tickRefCount;
                            }
                        }
