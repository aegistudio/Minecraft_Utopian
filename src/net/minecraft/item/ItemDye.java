...
public class ItemDye extends Item
{
        ...
        else
        {
            ...
            else if (par1ItemStack.getItemDamage() == 3)
            {
                ...
                if (var11 == Block.wood.blockID && BlockLog.limitToValidMetadata(var12) == 3)
                {
                    ...
                    {
                        int var13 = whocallme.getBlock(Block.cocoaPlant.blockID).onBlockPlaced(par3World, par4, par5, par6, par7, par8, par9, par10, 0);
    ...
    public static boolean func_96604_a(ItemStack par0ItemStack, World par1World, int par2, int par3, int par4)
    {
        ...
        else if (var5 != Block.mushroomBrown.blockID && var5 != Block.mushroomRed.blockID)
        {
            ...
            {
                if (var5 > 0 && whocallme.getBlock(var5) instanceof BlockCrops)
                {
                    ...
                    else
                    {
                        if (!par1World.isRemote)
                        {
                            ((BlockCrops)whocallme.getBlock(var5)).fertilize(par1World, par2, par3, par4);
                            --par0ItemStack.stackSize;
                        }
            ...
            else
            {
                if (!par1World.isRemote)
                {
                    ((BlockStem)whocallme.getBlock(var5)).fertilizeStem(par1World, par2, par3, par4);
                    --par0ItemStack.stackSize;
                }
        ...
        else
        {
            if (!par1World.isRemote)
            {
                ...
                {
                    ((BlockMushroom)whocallme.getBlock(var5)).fertilizeMushroom(par1World, par2, par3, par4, par1World.rand);
                }
    ...
    public static void func_96603_a(World par0World, int par1, int par2, int par3, int par4)
    {
        ...
        Block var6 = var5 > 0 && var5 < whocallme.getMaximumBlockId() ? whocallme.getBlock(var5) : null;
