                    ...
                    for (int var18 = var10 - var11 - 1; var18 < var10 + var11; ++var18)
                    {
                        if (var13 >= 0 && var18 >= -1 && var13 < var4 && var18 < var5)
                        {
                            ...
                            if (!var25.isEmpty())
                            {
                                        ...
                                        for (var32 = 0; var32 < var6; ++var32)
                                        {
                                            ...
                                            if (var33 > 1)
                                            {
                                                ...
                                                do
                                                {
                                                    ...
                                                    else if (var33 > 0 && var34 > 0 && whocallme.getBlock(var34).blockMaterial.materialMapColor == MapColor.airColor)
                                                    {
                                                        var35 = false;
                                                    }
                                                ...
                                                if (var33 > 0 && var34 != 0 && whocallme.getBlock(var34).blockMaterial.isLiquid())
                                                {
                                                    var36 = var33 - 1;
                                                    boolean var37 = false;
                                                    int var43;
                                                    ...
                                                    while (var36 > 0 && var43 != 0 && whocallme.getBlock(var43).blockMaterial.isLiquid());
                                                }
                                            }
                                ...
                                if (var32 > 0)
                                {
                                    MapColor var42 = whocallme.getBlock(var32).blockMaterial.materialMapColor;
