...
public class ItemBlock extends Item
{
    ...
    public int getSpriteNumber()
    {
        ...
        return whocallme.getBlock(this.blockID).getItemIconName() != null ? 1 : 0;
    }
    ...
    {
    	BlockInfoContainer whocallme = BlockInfoContainer.getBlockInfoContainer();
        return this.field_94588_b != null ? this.field_94588_b : whocallme.getBlock(this.blockID).getBlockTextureFromSide(1);
    }
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else if (par5 == 255 && whocallme.getBlock(this.blockID).blockMaterial.isSolid())
        {
            return false;
        }
        else if (par3World.canPlaceEntityOnSide(this.blockID, par4, par5, par6, false, par7, par2EntityPlayer, par1ItemStack))
        {
            Block var12 = whocallme.getBlock(this.blockID);
            int var13 = this.getMetadata(par1ItemStack.getItemDamage());
            int var14 = whocallme.getBlock(this.blockID).onBlockPlaced(par3World, par4, par5, par6, par7, par8, par9, par10, var13);

            if (par3World.setBlock(par4, par5, par6, this.blockID, var14, 3))
            {
                if (par3World.getBlockId(par4, par5, par6) == this.blockID)
                {
                    whocallme.getBlock(this.blockID).onBlockPlacedBy(par3World, par4, par5, par6, par2EntityPlayer, par1ItemStack);
                    whocallme.getBlock(this.blockID).onPostBlockPlaced(par3World, par4, par5, par6, var14);
                }
    ...
    {
    	BlockInfoContainer whocallme = BlockInfoContainer.getBlockInfoContainer();
        return whocallme.getBlock(this.blockID).getUnlocalizedName();
    }
    ...
    {
    	BlockInfoContainer whocallme = BlockInfoContainer.getBlockInfoContainer();
        return whocallme.getBlock(this.blockID).getCreativeTabToDisplayOn();
    }
    ...
    {
    	BlockInfoContainer whocallme = BlockInfoContainer.getBlockInfoContainer();
        String var2 = whocallme.getBlock(this.blockID).getItemIconName();
