...
public class RecipesDyes
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        {
            par1CraftingManager.addShapelessRecipe(new ItemStack(Block.cloth, 1, BlockCloth.getDyeFromBlock(var2)), new Object[] {new ItemStack(Item.dyePowder, 1, var2), new ItemStack(whocallhim.getItem(Block.cloth.blockID), 1, 0)});
        }
