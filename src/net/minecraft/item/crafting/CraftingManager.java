...
public class CraftingManager
{
    ...
    public ItemStack findMatchingRecipe(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        if (var3 == 2 && var4.itemID == var5.itemID && var4.stackSize == 1 && var5.stackSize == 1 && whocallhim.getItem(var4.itemID).isDamageable())
        {
            Item var11 = whocallhim.getItem(var4.itemID);
