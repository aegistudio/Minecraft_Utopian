...
public final class ItemStack
{
    ...
    public Item getItem()
    {
        ...
        return whocallhim.getItem(this.itemID);
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).getMaxDamage() > 0;
    }

    public boolean getHasSubtypes()
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).getHasSubtypes();
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).getMaxDamage();
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        boolean var3 = whocallhim.getItem(this.itemID).hitEntity(this, par1EntityLiving, par2EntityPlayer);
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        boolean var7 = whocallhim.getItem(this.itemID).onBlockDestroyed(this, par1World, par2, par3, par4, par5, par6EntityPlayer);
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).getDamageVsEntity(par1Entity);
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).canHarvestBlock(par1Block);
    }

    public boolean interactWith(EntityLiving par1EntityLiving)
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).itemInteractionForEntity(this, par1EntityLiving);
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return whocallhim.getItem(this.itemID).getUnlocalizedName(this);
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return this.stackSize + "x" + whocallhim.getItem(this.itemID).getUnlocalizedName() + "@" + this.itemDamage;
    }
    ...
    public void updateAnimation(World par1World, Entity par2Entity, int par3, boolean par4)
    {
        ...
        whocallhim.getItem(this.itemID).onUpdate(this, par1World, par2Entity, par3, par4);
    }
