...
public class Item
{
    ...
    public static ItemArmor helmetLeather = (ItemArmor)(new ItemArmor(42, EnumArmorMaterial.CLOTH, 0, ItemArmor.ARMORTYPE_HELMET)).setUnlocalizedName("helmetCloth");
    public static ItemArmor plateLeather = (ItemArmor)(new ItemArmor(43, EnumArmorMaterial.CLOTH, 0, ItemArmor.ARMORTYPE_CHESTPLATE)).setUnlocalizedName("chestplateCloth");
    public static ItemArmor legsLeather = (ItemArmor)(new ItemArmor(44, EnumArmorMaterial.CLOTH, 0, ItemArmor.ARMORTYPE_LEGGINGS)).setUnlocalizedName("leggingsCloth");
    public static ItemArmor bootsLeather = (ItemArmor)(new ItemArmor(45, EnumArmorMaterial.CLOTH, 0, ItemArmor.ARMORTYPE_BOOTS)).setUnlocalizedName("bootsCloth");
    public static ItemArmor helmetChain = (ItemArmor)(new ItemArmor(46, EnumArmorMaterial.CHAIN, 1, ItemArmor.ARMORTYPE_HELMET)).setUnlocalizedName("helmetChain");
    public static ItemArmor plateChain = (ItemArmor)(new ItemArmor(47, EnumArmorMaterial.CHAIN, 1, ItemArmor.ARMORTYPE_CHESTPLATE)).setUnlocalizedName("chestplateChain");
    public static ItemArmor legsChain = (ItemArmor)(new ItemArmor(48, EnumArmorMaterial.CHAIN, 1, ItemArmor.ARMORTYPE_LEGGINGS)).setUnlocalizedName("leggingsChain");
    public static ItemArmor bootsChain = (ItemArmor)(new ItemArmor(49, EnumArmorMaterial.CHAIN, 1, ItemArmor.ARMORTYPE_BOOTS)).setUnlocalizedName("bootsChain");
    public static ItemArmor helmetIron = (ItemArmor)(new ItemArmor(50, EnumArmorMaterial.IRON, 2, ItemArmor.ARMORTYPE_HELMET)).setUnlocalizedName("helmetIron");
    public static ItemArmor plateIron = (ItemArmor)(new ItemArmor(51, EnumArmorMaterial.IRON, 2, ItemArmor.ARMORTYPE_CHESTPLATE)).setUnlocalizedName("chestplateIron");
    public static ItemArmor legsIron = (ItemArmor)(new ItemArmor(52, EnumArmorMaterial.IRON, 2, ItemArmor.ARMORTYPE_LEGGINGS)).setUnlocalizedName("leggingsIron");
    public static ItemArmor bootsIron = (ItemArmor)(new ItemArmor(53, EnumArmorMaterial.IRON, 2, ItemArmor.ARMORTYPE_BOOTS)).setUnlocalizedName("bootsIron");
    public static ItemArmor helmetDiamond = (ItemArmor)(new ItemArmor(54, EnumArmorMaterial.DIAMOND, 3, ItemArmor.ARMORTYPE_HELMET)).setUnlocalizedName("helmetDiamond");
    public static ItemArmor plateDiamond = (ItemArmor)(new ItemArmor(55, EnumArmorMaterial.DIAMOND, 3, ItemArmor.ARMORTYPE_CHESTPLATE)).setUnlocalizedName("chestplateDiamond");
    public static ItemArmor legsDiamond = (ItemArmor)(new ItemArmor(56, EnumArmorMaterial.DIAMOND, 3, ItemArmor.ARMORTYPE_LEGGINGS)).setUnlocalizedName("leggingsDiamond");
    public static ItemArmor bootsDiamond = (ItemArmor)(new ItemArmor(57, EnumArmorMaterial.DIAMOND, 3, ItemArmor.ARMORTYPE_BOOTS)).setUnlocalizedName("bootsDiamond");
    public static ItemArmor helmetGold = (ItemArmor)(new ItemArmor(58, EnumArmorMaterial.GOLD, 4, ItemArmor.ARMORTYPE_HELMET)).setUnlocalizedName("helmetGold");
    public static ItemArmor plateGold = (ItemArmor)(new ItemArmor(59, EnumArmorMaterial.GOLD, 4, ItemArmor.ARMORTYPE_CHESTPLATE)).setUnlocalizedName("chestplateGold");
    public static ItemArmor legsGold = (ItemArmor)(new ItemArmor(60, EnumArmorMaterial.GOLD, 4, ItemArmor.ARMORTYPE_LEGGINGS)).setUnlocalizedName("leggingsGold");
    public static ItemArmor bootsGold = (ItemArmor)(new ItemArmor(61, EnumArmorMaterial.GOLD, 4, ItemArmor.ARMORTYPE_BOOTS)).setUnlocalizedName("bootsGold");
