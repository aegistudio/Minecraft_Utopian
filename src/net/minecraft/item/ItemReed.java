...
public class ItemReed extends Item
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                Block var12 = whocallme.getBlock(this.spawnID);
                ...
                if (par3World.setBlock(par4, par5, par6, this.spawnID, var13, 3))
                {
                    ...
                    {
                        whocallme.getBlock(this.spawnID).onBlockPlacedBy(par3World, par4, par5, par6, par2EntityPlayer, par1ItemStack);
                        whocallme.getBlock(this.spawnID).onPostBlockPlaced(par3World, par4, par5, par6, var13);
                    }
