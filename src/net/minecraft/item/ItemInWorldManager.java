...
public class ItemInWorldManager
{
    ...
    public void updateBlockRemoving()
    {
        ...
        if (this.receivedFinishDiggingPacket)
        {
            ...
            {
                Block var3 = whocallme.getBlock(var2);
        ...
        else if (this.isDestroyingBlock)
        {
            ...
            Block var6 = whocallme.getBlock(var1);
    ...
    public void onBlockClicked(int par1, int par2, int par3, int par4)
    {
        ...
        if (!this.gameType.isAdventure() || this.thisPlayerMP.canCurrentToolHarvestBlock(par1, par2, par3))
        {
            ...
            else
            {
                ...
                if (var6 > 0)
                {
                    whocallme.getBlock(var6).onBlockClicked(this.theWorld, par1, par2, par3, this.thisPlayerMP);
                    var5 = whocallme.getBlock(var6).getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, par1, par2, par3);
                }
    ...
    private boolean removeBlock(int par1, int par2, int par3)
    {
        ...
        Block var4 = whocallme.getBlock(this.theWorld.getBlockId(par1, par2, par3));
    ...
    public boolean tryHarvestBlock(int par1, int par2, int par3)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                boolean var8 = this.thisPlayerMP.canHarvestBlock(whocallme.getBlock(var4));
                ...
                if (var6 && var8)
                {
                    whocallme.getBlock(var4).harvestBlock(this.theWorld, this.thisPlayerMP, par1, par2, par3, var5);
                }
            }
    ...
    public boolean activateBlockOrUseItem(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (!par1EntityPlayer.isSneaking() || par1EntityPlayer.getHeldItem() == null)
        {
            ...
            if (var11 > 0 && whocallme.getBlock(var11).onBlockActivated(par2World, par4, par5, par6, par1EntityPlayer, par7, par8, par9, par10))
            {
                return true;
            }
        }
