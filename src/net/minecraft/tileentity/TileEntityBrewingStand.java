...
public class TileEntityBrewingStand extends TileEntity implements ISidedInventory
{
    ...
    private boolean canBrew()
    {
        if (this.brewingItemStacks[3] != null && this.brewingItemStacks[3].stackSize > 0)
        {
            ...
            if (!whocallhim.getItem(var1.itemID).isPotionIngredient())
            {
                return false;
            }
            else
    ...
    private void brewPotions()
    {
        ...
        if (this.canBrew())
        {
            ...
            if (whocallhim.getItem(var1.itemID).hasContainerItem())
            {
                this.brewingItemStacks[3] = new ItemStack(whocallhim.getItem(var1.itemID).getContainerItem());
            }
            else
            {
    ...
    {
    	if(par2ItemStack == null) return par1;
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
    	Item targetItem = whocallhim.getItem(par2ItemStack.itemID);
        if(targetItem.isPotionIngredient()) return PotionHelper.applyIngredient(par1, targetItem.getPotionEffect());
        return par1;
    }
    ...
    {
    	ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        return par1 == 3 ? whocallhim.getItem(par2ItemStack.itemID).isPotionIngredient() : par2ItemStack.itemID == Item.potion.itemID || par2ItemStack.itemID == Item.glassBottle.itemID;
    }
