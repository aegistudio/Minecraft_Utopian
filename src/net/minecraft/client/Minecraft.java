...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    private final ILogAgent logger = new LogAgent("Minecraft-Utopian", " [CLIENT]", (new File(getMinecraftDir(), "output-client.log")).getAbsolutePath());
    ...
    public void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft Utopian");
    ...
    public void displayGuiScreen(GuiScreen guiscreen)
    {
        ...
        if (guiscreen != null)
        {
            ...
            ScaledResolution resolution = new ScaledResolution(this.gameSettings, this.displayWidth, this.displayHeight);
            int width = resolution.getScaledWidth();
            int height = resolution.getScaledHeight();
            ((GuiScreen)guiscreen).setWorldAndResolution(this, width, height);
    ...
    private void displayDebugInfo(long par1)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            Tessellator tessellator = Tessellator.instance;
            short margin = 160;
            int debugInfoWidth = this.displayWidth - margin - 10;
            int debugInfoHeight = this.displayHeight - margin * 2;
            GL11.glEnable(GL11.GL_BLEND);
            tessellator.startDrawingQuads();
            tessellator.setColorRGBA_I(0, 200);
            tessellator.addVertex((double)((float)debugInfoWidth - (float)margin * 1.1F), (double)((float)debugInfoHeight - (float)margin * 0.6F - 16.0F), 0.0D);
            tessellator.addVertex((double)((float)debugInfoWidth - (float)margin * 1.1F), (double)(debugInfoHeight + margin * 2), 0.0D);
            tessellator.addVertex((double)((float)debugInfoWidth + (float)margin * 1.1F), (double)(debugInfoHeight + margin * 2), 0.0D);
            tessellator.addVertex((double)((float)debugInfoWidth + (float)margin * 1.1F), (double)((float)debugInfoHeight - (float)margin * 0.6F - 16.0F), 0.0D);
            tessellator.draw();
            ...
            for (int var11 = 0; var11 < var3.size(); ++var11)
            {
                ...
                tessellator.setColorOpaque_I(var12.func_76329_a());
                tessellator.addVertex((double)debugInfoWidth, (double)debugInfoHeight, 0.0D);
                int var14;
                float var15;
                float var17;
                float var16;
                ...
                for (var14 = var13; var14 >= 0; --var14)
                {
                    ...
                    var16 = MathHelper.sin(var15) * (float)margin;
                    var17 = MathHelper.cos(var15) * (float)margin * 0.5F;
                    tessellator.addVertex((double)((float)debugInfoWidth + var16), (double)((float)debugInfoHeight - var17), 0.0D);
                }

                tessellator.draw();
                tessellator.startDrawing(5);
                tessellator.setColorOpaque_I((var12.func_76329_a() & 16711422) >> 1);
                ...
                for (var14 = var13; var14 >= 0; --var14)
                {
                    ...
                    var17 = MathHelper.cos(var15) * (float)margin * 0.5F;
                    tessellator.addVertex((double)((float)debugInfoWidth + var16), (double)((float)debugInfoHeight - var17), 0.0D);
                    tessellator.addVertex((double)((float)debugInfoWidth + var16), (double)((float)debugInfoHeight - var17 + 10.0F), 0.0D);
                }
            ...
            var13 = 16777215;
            this.fontRenderer.drawStringWithShadow(var18, debugInfoWidth - margin, debugInfoHeight - margin / 2 - 16, var13);
            this.fontRenderer.drawStringWithShadow(var18 = var19.format(var4.field_76330_b) + "%", debugInfoWidth + margin - this.fontRenderer.getStringWidth(var18), debugInfoHeight - margin / 2 - 16, var13);
            ...
            for (int var21 = 0; var21 < var3.size(); ++var21)
            {
                ...
                this.fontRenderer.drawStringWithShadow(var22, debugInfoWidth - margin, debugInfoHeight + margin / 2 + var21 * 8 + 20, var20.func_76329_a());
                this.fontRenderer.drawStringWithShadow(var22 = var19.format(var20.field_76332_a) + "%", debugInfoWidth + margin - 50 - this.fontRenderer.getStringWidth(var22), debugInfoHeight + margin / 2 + var21 * 8 + 20, var20.func_76329_a());
                this.fontRenderer.drawStringWithShadow(var22 = var19.format(var20.field_76330_b) + "%", debugInfoWidth + margin - this.fontRenderer.getStringWidth(var22), debugInfoHeight + margin / 2 + var21 * 8 + 20, var20.func_76329_a());
            }
        }
    }
    ...
    public static void main(String[] arguments)
    {
        ...
        boolean var3 = true;
        boolean var4 = false;
        String auto_generated_playername = "Player" + getSystemTime() % 1000L;
        String generated_playername = auto_generated_playername;

        if (arguments.length > 0) generated_playername = arguments[0];

        String session_id = "-";

        if (arguments.length > 1) session_id = arguments[1];

        ArrayList<String> var8 = new ArrayList<String>();

        for (int var9 = 2; var9 < arguments.length; ++var9)
        {
            String var10 = arguments[var9];
            String var11 = var9 == arguments.length - 1 ? null : arguments[var9 + 1];
            boolean var12 = false;
            ...
            if (!var10.equals("-demo") && !var10.equals("--demo"))
            {
                ...
                {
                    String[] var13 = HttpUtil.loginToMinecraft((ILogAgent)null, generated_playername, var11);

                    if (var13 != null)
                    {
                        generated_playername = var13[0];
                        session_id = var13[1];
                        var8.add("Logged in insecurely as " + generated_playername);
                    }
                    else
                    {
                        var8.add("Could not log in as " + generated_playername + " with given password");
                    }
        ...
        if (generated_playername.contains("@") && session_id.length() <= 1)
        {
            generated_playername = auto_generated_playername;
        }

        attributes.put("demo", "" + var2);
        attributes.put("stand-alone", "" + var3);
        ...
        MinecraftFakeLauncher launcher = new MinecraftFakeLauncher(attributes);
        MinecraftApplet minecraft_applet = new MinecraftApplet();
        minecraft_applet.setStub(launcher);
        launcher.setLayout(new BorderLayout());
        launcher.add(minecraft_applet, "Center");
        launcher.validate();
        frame.removeAll();
        frame.setLayout(new BorderLayout());
        frame.add(launcher, "Center");
        frame.validate();
        minecraft_applet.init();
        Iterator<String> var19 = var8.iterator();
        ...
        //XXX Starting game, see also void run() in this class.
        minecraft_applet.start();	
    ...
    private void clickMiddleMouseButton()
    {
        if (this.objectMouseOver != null)
        {
            ...
            if (this.objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                Block var8 = BlockInfoContainer.getBlockInfoContainer().getBlock(this.theWorld.getBlockId(var5, var6, var7));
                ...
                var4 = whocallhim.getItem(var2).getHasSubtypes();
                //XXX this method is interesting!
                int var9 = var2 < 256 && !BlockInfoContainer.getBlockInfoContainer().getBlock(var8.blockID).isFlowerPot() ? var2 : var8.blockID;
                var3 = BlockInfoContainer.getBlockInfoContainer().getBlock(var9).getDamageValue(this.theWorld, var5, var6, var7);
            }
            else
            {
