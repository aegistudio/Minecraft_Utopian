...
public abstract class GuiSlot
{
    ...
    {
        int var3 = (this.width - SLOT_BOX_WIDTH) / 2;
        int var4 = (this.width + SLOT_BOX_WIDTH) / 2;
    ...
    protected int SLOT_BOX_WIDTH = 220;
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        for (var11 = 0; var11 < var4; ++var11)
        {
            ...
            if (var19 <= this.bottom && var19 + var13 >= this.top)
            {
                ...
                {
                    var14 = (this.width - this.SLOT_BOX_WIDTH) / 2;
                    int var15 = (this.width + this.SLOT_BOX_WIDTH) / 2;
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    protected int SLOT_BAR_BIAS = 14;
    
    protected int getScrollBarX()
    {
        return (this.width + this.SLOT_BOX_WIDTH) / 2 + SLOT_BAR_BIAS;
    }
