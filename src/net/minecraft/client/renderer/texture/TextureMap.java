...
public class TextureMap implements IconRegister
{
    ...
    public void refreshTextures()
    {
        ...
        if (this.textureType == 0)
        {
            ...
            Block[] registeredblocks = whocallme.getRegisteredBlocks();
            var2 = registeredblocks.length;

            for (Block block : registeredblocks) if (block != null)
        ...
        Item[] registereditems = whocallhim.getRegisteredItems();

        for (Item item : registereditems) if (item != null)
        {
