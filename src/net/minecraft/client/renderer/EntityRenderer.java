...
public class EntityRenderer
{
    ...
    private float getFOVModifier(float par1, boolean par2)
    {
        ...
        else
        {
            ...
            if (var6 != 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(var6).blockMaterial == Material.water)
            {
        ...
        if (var1 != 0.0F)
        {
            ...
            for (int var16 = 0; var16 < var15; ++var16)
            {
                ...
                if (var19 <= var5 + var7 && var19 >= var5 - var7 && var21.canSpawnLightningBolt() && var21.getFloatTemperature() >= 0.2F)
                {
                    ...
                    if (var20 > 0)
                    {
                        if (BlockInfoContainer.getBlockInfoContainer().getBlock(var20).blockMaterial == Material.lava)
                        {
                            this.mc.effectRenderer.addEffect(new EntitySmokeFX(var3, (double)((float)var17 + var22), (double)((float)var19 + 0.1F) - BlockInfoContainer.getBlockInfoContainer().getBlock(var20).getBlockBoundsMinY(), (double)((float)var18 + var23), 0.0D, 0.0D, 0.0D));
                        }
                        else
                        {
                            ++var14;
                            ...
                            if (this.random.nextInt(var14) == 0)
                            {
                                ...
                                var10 = (double)((float)var19 + 0.1F) - BlockInfoContainer.getBlockInfoContainer().getBlock(var20).getBlockBoundsMinY();
                                var12 = (double)((float)var18 + var23);
                            }

                            this.mc.effectRenderer.addEffect(new EntityRainFX(var3, (double)((float)var17 + var22), (double)((float)var19 + 0.1F) - BlockInfoContainer.getBlockInfoContainer().getBlock(var20).getBlockBoundsMinY(), (double)((float)var18 + var23)));
                        }
                    }
                }
            }
    ...
    private void updateFogColor(float par1)
    {
        ...
        else if (var21 != 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(var21).blockMaterial == Material.water)
        {
            this.fogColorRed = 0.02F;
            this.fogColorGreen = 0.02F;
            this.fogColorBlue = 0.2F;
        }
        else if (var21 != 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(var21).blockMaterial == Material.lava)
        {
    ...
    private void setupFog(int par1, float par2)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if (var5 > 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(var5).blockMaterial == Material.water)
                {
                    GL11.glFogi(GL11.GL_FOG_MODE, GL11.GL_EXP);
                ...
                else if (var5 > 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(var5).blockMaterial == Material.lava)
                {
                    GL11.glFogi(GL11.GL_FOG_MODE, GL11.GL_EXP);
