            ...
            for (int var32 = var20; var32 <= var21; ++var32)
            {
                for (int var33 = var22; var33 <= var23; ++var33)
                {
                    ...
                    if (var34 > 0 && var10.getBlockLightValue(var31, var32, var33) > 3)
                    {
                        ...
                        this.renderShadowOnBlock(whocallme.getBlock(var34), par2, par4 + (double)par1Entity.getShadowSize(), par6, var31, var32, var33, par8, var11, var24, var26 + (double)par1Entity.getShadowSize(), var28);
                    }
                }
            }
        }
