...
public class RenderBiped extends RenderLiving
{
    ...
    protected void renderEquippedItems(EntityLiving par1EntityLiving, float par2)
    {
        ...
        if (var5 != null)
        {
            ...
            {
                if (RenderBlocks.renderItemIn3d(whocallme.getBlock(var5.itemID).getRenderType()))
                {
                    var6 = 0.625F;
        ...
        if (var4 != null)
        {
            ...
            if (var4.itemID < 256 && RenderBlocks.renderItemIn3d(whocallme.getBlock(var4.itemID).getRenderType()))
            {
                var6 = 0.5F;
            ...
            else if (whocallhim.getItem(var4.itemID).isFull3D())
            {
                var6 = 0.625F;

                if (whocallhim.getItem(var4.itemID).shouldRotateAroundWhenRendering())
                {
