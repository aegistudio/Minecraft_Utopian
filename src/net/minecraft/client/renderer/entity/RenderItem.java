...
public class RenderItem extends Render
{
    ...
    public void doRenderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (var10.getItem() != null)
        {
            ...
            if (var10.getItemSpriteNumber() == 0 && whocallme.getBlock(var10.itemID) != null && RenderBlocks.renderItemIn3d(whocallme.getBlock(var10.itemID).getRenderType()))
            {
                Block var21 = whocallme.getBlock(var10.itemID);
            ...
            else
            {
                ...
                if (var10.getItem().requiresMultipleRenderPasses())
                {
                    ...
                    for (int var14 = 0; var14 <= 1; ++var14)
                    {
                        ...
                        {
                            var17 = whocallhim.getItem(var10.itemID).getColorFromItemStack(var10, var14);
                ...
                else
                {
                    ...
                    if (this.renderWithColor)
                    {
                        int var22 = whocallhim.getItem(var10.itemID).getColorFromItemStack(var10, 0);
    ...
    private void renderDroppedItem(EntityItem par1EntityItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderManager.options.fancyGraphics)
        {
            ...
            for (int var20 = 0; var20 < var24; ++var20)
            {
                ...
                if (var18.getItemSpriteNumber() == 0 && whocallme.getBlock(var18.itemID) != null)
                {
                    this.loadTexture("/terrain.png");
                }
                else
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, int par4, int par5)
    {
        ...
        if (par3ItemStack.getItemSpriteNumber() == 0 && RenderBlocks.renderItemIn3d(whocallme.getBlock(var6).getRenderType()))
        {
            par2RenderEngine.bindTexture("/terrain.png");
            Block var15 = whocallme.getBlock(var6);
            GL11.glPushMatrix();
            ...
            int var18 = whocallhim.getItem(var6).getColorFromItemStack(par3ItemStack, 0);
        ...
        else
        {
            ...
            if (whocallhim.getItem(var6).requiresMultipleRenderPasses())
            {
                GL11.glDisable(GL11.GL_LIGHTING);
                ...
                {
                    Icon var10 = whocallhim.getItem(var6).getIconFromDamageForRenderPass(var7, var9);
                    int var11 = whocallhim.getItem(var6).getColorFromItemStack(par3ItemStack, var9);
            ...
            else
            {
                ...
                var9 = whocallhim.getItem(var6).getColorFromItemStack(par3ItemStack, 0);
