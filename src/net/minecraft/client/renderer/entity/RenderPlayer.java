...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (var4 != null)
        {
            ...
            {
                if (RenderBlocks.renderItemIn3d(whocallme.getBlock(var4.itemID).getRenderType()))
                {
                    var5 = 0.625F;
        ...
        if (var21 != null)
        {
            ...
            if (var21.itemID < 256 && RenderBlocks.renderItemIn3d(whocallme.getBlock(var21.itemID).getRenderType()))
            {
                var7 = 0.5F;
            ...
            else if (whocallhim.getItem(var21.itemID).isFull3D())
            {
                var7 = 0.625F;

                if (whocallhim.getItem(var21.itemID).shouldRotateAroundWhenRendering())
                {
