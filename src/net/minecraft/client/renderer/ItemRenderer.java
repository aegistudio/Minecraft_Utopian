...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLiving par1EntityLiving, ItemStack par2ItemStack, int par3)
    {
        ...
        if (par2ItemStack.getItemSpriteNumber() == 0 && BlockInfoContainer.getBlockInfoContainer().getBlock(par2ItemStack.itemID) != null && RenderBlocks.renderItemIn3d(BlockInfoContainer.getBlockInfoContainer().getBlock(par2ItemStack.itemID).getRenderType()))
        {
            this.mc.renderEngine.bindTexture("/terrain.png");
            this.renderBlocksInstance.renderBlockAsItem(BlockInfoContainer.getBlockInfoContainer().getBlock(par2ItemStack.itemID), par2ItemStack.getItemDamage(), 1.0F);
        }
        else
        {
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        if (var17 != null)
        {
            ...
            var18 = whocallhim.getItem(var17.itemID).getColorFromItemStack(var17, 0);
        ...
        else if (var17 != null)
        {
            ...
            if (var17.getItem().requiresMultipleRenderPasses())
            {
                ...
                ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
                int var25 = whocallhim.getItem(var17.itemID).getColorFromItemStack(var17, 1);
    ...
    public void renderOverlays(float par1)
    {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock())
        {
            ...
            {
                this.renderInsideOfBlock(par1, BlockInfoContainer.getBlockInfoContainer().getBlock(var5).getBlockTextureFromSide(2));
            }
            else
            {
            ...
            if (BlockInfoContainer.getBlockInfoContainer().getBlock(var5) != null)
            {
                this.renderInsideOfBlock(par1, BlockInfoContainer.getBlockInfoContainer().getBlock(var5).getBlockTextureFromSide(2));
            }
        }
