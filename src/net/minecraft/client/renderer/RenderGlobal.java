...
public class RenderGlobal implements IWorldAccess
{
        ...
        if (!this.damagedBlocks.isEmpty())
        {
            ...
            while (var10.hasNext())
            {
                ...
                else
                {
                    ...
                    Block var19 = var18 > 0 ? whocallme.getBlock(var18) : null;
    ...
    public void drawSelectionBox(EntityPlayer par1EntityPlayer, MovingObjectPosition par2MovingObjectPosition, int par3, ItemStack par4ItemStack, float par5)
    {
        ...
        if (par3 == 0 && par2MovingObjectPosition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if (var7 > 0)
            {
                whocallme.getBlock(var7).setBlockBoundsBasedOnState(this.theWorld, par2MovingObjectPosition.blockX, par2MovingObjectPosition.blockY, par2MovingObjectPosition.blockZ);
                ...
                this.drawOutlinedBoundingBox(whocallme.getBlock(var7).getSelectedBoundingBoxFromPool(this.theWorld, par2MovingObjectPosition.blockX, par2MovingObjectPosition.blockY, par2MovingObjectPosition.blockZ).expand((double)var6, (double)var6, (double)var6).getOffsetBoundingBox(-var8, -var10, -var12));
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else if (par1Str.startsWith("iconcrack_"))
                    {
                        ...
                        var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, whocallhim.getItem(var27), this.renderEngine);
                    }
                    else if (par1Str.startsWith("tilecrack_"))
                    {
                        ...
                        var21 = (new EntityDiggingFX(this.theWorld, par2, par4, par6, par8, par10, par12, whocallme.getBlock(var25), 0, var26, this.renderEngine)).applyRenderColor(var26);
                    }
    ...
    public void playAuxSFX(EntityPlayer par1EntityPlayer, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        switch (par2)
        {
            ...
            case 1005:
                if (whocallhim.getItem(par6) instanceof ItemRecord)
                {
                    this.theWorld.playRecord(((ItemRecord)whocallhim.getItem(par6)).recordName, par3, par4, par5);
                }
                else
                {
            ...
            case 2001:
                ...
                if (var20 > 0)
                {
                    Block var40 = whocallme.getBlock(var20);
