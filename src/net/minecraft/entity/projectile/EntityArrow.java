...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        if (var16 > 0)
        {
            whocallme.getBlock(var16).setBlockBoundsBasedOnState(this.worldObj, this.xTile, this.yTile, this.zTile);
            AxisAlignedBB var2 = whocallme.getBlock(var16).getCollisionBoundingBoxFromPool(this.worldObj, this.xTile, this.yTile, this.zTile);
        ...
        else
        {
            ...
            if (var4 != null)
            {
                ...
                else
                {
                    ...
                    if (this.inTile != 0)
                    {
                        whocallme.getBlock(this.inTile).onEntityCollidedWithBlock(this.worldObj, this.xTile, this.yTile, this.zTile, this);
                    }
                }
            }
