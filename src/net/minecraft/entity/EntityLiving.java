...
public abstract class EntityLiving extends Entity
{
    ...
    protected void updateFallState(double par1, boolean par3)
    {
        ...
        if (par3 && this.fallDistance > 0.0F)
        {
            ...
            if (var7 > 0)
            {
                whocallme.getBlock(var7).onFallenUpon(this.worldObj, var4, var5, var6, this, this.fallDistance);
            }
        }
    ...
    protected void fall(float par1)
    {
        ...
        if (var2 > 0)
        {
            ...
            if (var3 > 0)
            {
                StepSound var4 = whocallme.getBlock(var3).stepSound;
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
        ...
        else
        {
            ...
            if (this.onGround)
            {
                ...
                if (var4 > 0)
                {
                    var3 = whocallme.getBlock(var4).slipperiness * 0.91F;
                }
            }
            ...
            if (this.onGround)
            {
                ...
                if (var6 > 0)
                {
                    var3 = whocallme.getBlock(var6).slipperiness * 0.91F;
                }
            }
