...
public class EntityAIControlledByPlayer extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        if (this.thisEntity.onGround)
        {
            ...
            if (var9 > 0)
            {
                var8 = whocallme.getBlock(var9).slipperiness * 0.91F;
            }
        }
        ...
        if (var4 != var17 || var6 != var18)
        {
            ...
            boolean var22 = this.func_98216_b(var20) || whocallme.getBlock(var20) == null && this.func_98216_b(var21);
    ...
    {
    	BlockInfoContainer whocallme = BlockInfoContainer.getBlockInfoContainer();
    	Block theBlock = whocallme.getBlock(par1);
        return theBlock != null && (theBlock.getRenderType() == 10 || theBlock instanceof BlockHalfSlab);
    }
