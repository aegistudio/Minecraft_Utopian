            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.onGround)
                {
                    ...
                    if (this.worldObj.getBlockId(var1, var2, var3) != Block.pistonMoving.blockID)
                    {
                        ...
                        {
                            if (whocallme.getBlock(this.blockID) instanceof BlockSand)
                            {
                                ((BlockSand)whocallme.getBlock(this.blockID)).onFinishFalling(this.worldObj, var1, var2, var3, this.metadata);
                            }

                            if (this.fallingBlockTileEntityData != null && whocallme.getBlock(this.blockID) instanceof ITileEntityProvider)
                            {
                        ...
                        {
                            this.entityDropItem(new ItemStack(this.blockID, 1, whocallme.getBlock(this.blockID).damageDropped(this.metadata)), 0.0F);
                        }
                    }
                }
