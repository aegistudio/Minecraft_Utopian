    ...
    public void onUpdateEntity()
    {
        try
        {
            ...
            for (int var1 = 0; var1 < this.inventory.getSizeInventory(); ++var1)
            {
                ...
                if (var5 != null && whocallhim.getItem(var5.itemID).isMap() && this.playerNetServerHandler.packetSize() <= 5)
                {
                    Packet var6 = ((ItemMapBase)whocallhim.getItem(var5.itemID)).createMapDataPacket(var5, this.worldObj, this);
