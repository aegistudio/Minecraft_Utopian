...
public class EntityWolf extends EntityTameable
{
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (this.isTamed())
        {
            if (var2 != null)
            {
                if (whocallhim.getItem(var2.itemID) instanceof ItemFood)
                {
                    ItemFood var3 = (ItemFood)whocallhim.getItem(var2.itemID);
    ...
    public boolean isBreedingItem(ItemStack par1ItemStack)
    {
        ...
        ItemInfoContainer whocallhim = ItemInfoContainer.getItemInfoContainer();
        if(!(whocallhim.getItem(par1ItemStack.itemID) instanceof ItemFood)) return false;
        return ((ItemFood)whocallhim.getItem(par1ItemStack.itemID)).isWolfsFavoriteMeat();
    }
