...
public abstract class Entity
{
    ...
    public void moveEntity(double par1, double par3, double par5)
    {
        ...
        else
        {
            ...
            List<AxisAlignedBB> var35 = this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.addCoord(par1, par3, par5));
            ...
            if (this.canTriggerWalking() && !var20 && this.ridingEntity == null)
            {
                ...
                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var32 > 0)
                {
                    ...
                    whocallme.getBlock(var32).onEntityWalking(this.worldObj, var37, var30, var31, this);
                }
            }
            ...
            for (int var7 = var1; var7 <= var4; ++var7)
            {
                for (int var8 = var2; var8 <= var5; ++var8)
                {
                    for (int var9 = var3; var9 <= var6; ++var9)
                    {
                        ...
                        if (var10 > 0)
                        {
                            whocallme.getBlock(var10).onEntityCollidedWithBlock(this.worldObj, var7, var8, var9, this);
                        }
                    }
                }
            }
    ...
    protected void playStepSound(int par1, int par2, int par3, int par4)
    {
        ...
        StepSound var5 = whocallme.getBlock(par4).stepSound;
        ...
        else if (!whocallme.getBlock(par4).blockMaterial.isLiquid())
        {
            this.playSound(var5.getStepSound(), var5.getVolume() * 0.15F, var5.getPitch());
        }
    }
    ...
    public boolean isInsideOfMaterial(Material par1Material)
    {
        ...
        if (var7 != 0 && whocallme.getBlock(var7).blockMaterial == par1Material)
        {
    ...
    public void setPositionAndRotation2(double par1, double par3, double par5, float par7, float par8, int par9)
    {
        ...
        this.setRotation(par7, par8);
        List<AxisAlignedBB> var10 = this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.contract(0.03125D, 0.0D, 0.03125D));
